...
export const FeatureFlagsCreateBody = zod.object({
    ...
    _create_in_folder: zod.string().optional().describe('Optional folder short ID to place the feature flag in.'),
    _should_create_usage_dashboard: zod
        .boolean()
        .optional()
        .describe('Whether to generate a usage dashboard after flag creation.'),
})
...
export const FeatureFlagsPartialUpdateBody = zod.object({
    ...
    evaluation_tags: zod
        ...
        .optional()
        .describe('Evaluation context tags. Must be a subset of `tags`.'),
    deleted: zod.boolean().optional().describe('Soft-delete flag state.'),
    _create_in_folder: zod.string().optional().describe('Optional folder short ID to place the feature flag in.'),
    _should_create_usage_dashboard: zod
        .boolean()
        .optional()
        .describe('Whether to generate a usage dashboard when creating metadata.'),
})
...
export const FeatureFlagsLocalEvaluationRetrieveResponse = zod.object({
    flags: zod.array(
        zod.object({
            ...
            evaluation_tags: zod.array(zod.string()),
        })
    ),
