 ...
 */
export type CreationContextDaaEnumApi = (typeof CreationContextDaaEnumApi)[keyof typeof CreationContextDaaEnumApi]

export const CreationContextDaaEnumApi = {
...
* `web_experiments` - web_experiments
* `product_tours` - product_tours */
    creation_context?: CreationContextDaaEnumApi
    /** @nullable */
