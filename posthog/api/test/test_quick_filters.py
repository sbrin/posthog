...
class TestQuickFilters(APIBaseTest):
    ...
    def test_delete_quick_filter_handles_dashboard_with_quick_filter_ids(self, _name, initial_value, expected_value):
        quick_filter = self._create_quick_filter()

        dashboard = Dashboard.objects.create(
            team=self.team,
            name="Dashboard",
            quick_filter_ids=initial_value,
        )
        ...
        self.assertEqual(dashboard.quick_filter_ids, expected_value)
